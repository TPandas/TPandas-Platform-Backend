    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_auth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
                ('update_auth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='修改者')),
            ],
            options={
                'verbose_name': '页面元素类型',
        ...
        migrations.AddField(
            model_name='casemodel',
            name='update_auth',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='修改者'),
        ),
        migrations.CreateModel(
            name='CaseDateModel',
            fields=[
